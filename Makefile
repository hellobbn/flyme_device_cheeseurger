...
#-----------------------------------------------------------------------------
vendor_modify_jars := com.qti.dpmframework framework oem-services qti-telephony-common services telephony-common wifi-service
