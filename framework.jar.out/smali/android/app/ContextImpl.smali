...
.method private constructor <init>(Landroid/app/ContextImpl;Landroid/app/ActivityThread;Landroid/app/LoadedApk;Landroid/os/IBinder;Landroid/os/UserHandle;ILandroid/view/Display;Landroid/content/res/Configuration;I)V
    ...
    .line 2046
    .local v12, "compatInfo":Landroid/content/res/CompatibilityInfo;
    if-eqz p1, :cond_2

    .line 2047
    move-object/from16 v0, p1

    invoke-virtual {v0, v10}, Landroid/app/ContextImpl;->getDisplayAdjustments(I)Landroid/view/DisplayAdjustments;
    ...
    .line 2049
    .end local v12    # "compatInfo":Landroid/content/res/CompatibilityInfo;
    :cond_2
    if-nez v12, :cond_3
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/app/ContextImpl;->getPackageName()Ljava/lang/String;
    ...
    iget-object v9, v5, Landroid/content/pm/ApplicationInfo;->sharedLibraryFiles:[Ljava/lang/String;
    ...
    move-object/from16 v1, p0
    invoke-direct {v1, v0}, Landroid/app/ContextImpl;->setFlymeThemeResource(Landroid/content/res/Resources;)V
    ...
    iget v3, v12, Landroid/content/res/CompatibilityInfo;->applicationScale:F
    ...
    invoke-virtual {v3, v10, v4}, Landroid/app/ResourcesManager;->getAdjustedDisplay(ILandroid/view/DisplayAdjustments;)Landroid/view/Display;
    ...
    .line 2111
    .local v14, "ainfo":Landroid/content/pm/ApplicationInfo;
...
.method public checkNeedToShowPermissionRequst()Z
    ...
    invoke-virtual {v0}, Landroid/app/ActivityThread;->checkNeedToShowPermissionRequst()Z
...
.method public getPermissionService(I)Landroid/os/Messenger;
    ...
    invoke-virtual {v0, p1}, Landroid/app/ActivityThread;->getPermissionService(I)Landroid/os/Messenger;
