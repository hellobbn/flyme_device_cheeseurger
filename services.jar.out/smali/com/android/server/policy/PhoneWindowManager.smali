...
.field protected mScreenshotChordVolumeUpKeyTriggered:Z
...
.method static constructor <clinit>()V
    ...
    .line 192
    sput-boolean v3, Lcom/android/server/policy/PhoneWindowManager;->SHOW_STARTING_ANIMATIONS:Z
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/policy/PhoneWindowManager;->mKeyguardFingerprintChanageCallback:Ljava/lang/Runnable;
    ...
    .line 407
    iput v4, p0, Lcom/android/server/policy/PhoneWindowManager;->mVibrateOnTouchIntensity:I
...
.method public addStartingWindow(Landroid/os/IBinder;Ljava/lang/String;ILandroid/content/res/CompatibilityInfo;Ljava/lang/CharSequence;IIIILandroid/content/res/Configuration;)Landroid/view/View;
    ...
    .prologue
    .line 2854
    sget-boolean v14, Lcom/android/server/policy/PhoneWindowManager;->SHOW_STARTING_ANIMATIONS:Z
    ...
    sget-boolean v14, Lcom/android/server/policy/PhoneWindowManager;->DEBUG_STARTING_WINDOW:Z

    if-nez v14, :cond_2

    sget-boolean v14, Lcom/android/server/policy/PhoneWindowManager;->DEBUG_ONEPLUS:Z
    ...
    const-string/jumbo v16, "addStartingWindow "
    ...
    .line 2872
    const-string/jumbo v16, ": nonLocalizedLabel="
    ...
    invoke-virtual {v1, v0, v14}, Landroid/content/Context;->createPackageContext(Ljava/lang/String;I)Landroid/content/Context;
    ...
    const-string/jumbo v16, "addStartingWindow: creating context based on overrideConfig"
    ...
    .line 2885
    const-string/jumbo v16, " for starting window"
    ...
    .line 2888
    invoke-virtual {v6, v14}, Landroid/content/Context;->obtainStyledAttributes([I)Landroid/content/res/TypedArray;
    ...
    const-string/jumbo v16, "addStartingWindow: apply overrideConfig"
    ...
    .line 2896
    const-string/jumbo v16, " to starting window resId="
    ...
    invoke-direct {v12, v1}, Lcom/android/internal/policy/PhoneWindow;-><init>(Landroid/content/Context;)V

    .line 2902
    .local v12, "win":Lcom/android/internal/policy/PhoneWindow;
    const/4 v14, 0x1

    invoke-virtual {v12, v14}, Lcom/android/internal/policy/PhoneWindow;->setIsStartingWindow(Z)V
    ...
    invoke-virtual {v14, v0, v15}, Landroid/content/res/Resources;->getText(ILjava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v12, v5, v14}, Lcom/android/internal/policy/PhoneWindow;->setTitle(Ljava/lang/CharSequence;Z)V
    ...
    .line 2912
    invoke-virtual {v12, v14}, Lcom/android/internal/policy/PhoneWindow;->setType(I)V

    .line 2915
    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/server/policy/PhoneWindowManager;->mWindowManagerFuncs:Landroid/view/WindowManagerPolicy$WindowManagerFuncs;

    invoke-interface {v14}, Landroid/view/WindowManagerPolicy$WindowManagerFuncs;->getWindowManagerLock()Ljava/lang/Object;
    ...
    .line 2928
    invoke-virtual {v12, v14, v15}, Lcom/android/internal/policy/PhoneWindow;->setFlags(II)V

    .line 2938
    move/from16 v0, p7

    invoke-virtual {v12, v0}, Lcom/android/internal/policy/PhoneWindow;->setDefaultIcon(I)V

    .line 2939
    move/from16 v0, p8

    invoke-virtual {v12, v0}, Lcom/android/internal/policy/PhoneWindow;->setDefaultLogo(I)V
    ...
    .line 2941
    invoke-virtual {v12, v14, v15}, Lcom/android/internal/policy/PhoneWindow;->setLayout(II)V
    ...
    .line 2947
    invoke-virtual {v12}, Lcom/android/internal/policy/PhoneWindow;->getWindowStyle()Landroid/content/res/TypedArray;
    ...
    iput v14, v7, Landroid/view/WindowManager$LayoutParams;->windowAnimations:I
    ...
    iput v14, v7, Landroid/view/WindowManager$LayoutParams;->privateFlags:I
    ...
    const-string/jumbo v15, "Starting "
    ...
    invoke-virtual {v7, v14}, Landroid/view/WindowManager$LayoutParams;->setTitle(Ljava/lang/CharSequence;)V
    ...
    .line 2964
    .local v9, "themeController":Landroid/content/res/ThemeController;
    invoke-virtual {v9}, Landroid/content/res/ThemeController;->getThemeState()I
    ...
    invoke-virtual {v9, v0}, Landroid/content/res/ThemeController;->checkHasTheme(Ljava/lang/String;)Z
    ...
    invoke-virtual {v9, v14}, Landroid/content/res/ThemeController;->getCorrectThemeResource([I)I

    move-result v8

    .line 2966
    .restart local v8    # "resId":I
    invoke-virtual {v12, v8}, Lcom/android/internal/policy/PhoneWindow;->setStatusBarColor(I)V

    .line 2967
    const/4 v14, 0x1

    invoke-virtual {v12, v14, v8}, Lcom/android/internal/policy/PhoneWindow;->setStartupWindowTheme(ZI)V

    .line 2973
    .end local v8    # "resId":I
    :goto_2
    invoke-virtual {v12}, Lcom/android/internal/policy/PhoneWindow;->getDecorView()Landroid/view/View;
    ...
    const-string/jumbo v16, "Adding starting window for "
    ...
    .line 2978
    :cond_b
    invoke-interface {v13, v11, v7}, Landroid/view/WindowManager;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 2995
    invoke-interface {v13, v11}, Landroid/view/WindowManager;->removeViewImmediate(Landroid/view/View;)V
    ...
    .end local v9    # "themeController":Landroid/content/res/ThemeController;
    .local v11, "view":Landroid/view/View;
    .local v13, "wm":Landroid/view/WindowManager;
    :cond_d
    const/4 v14, 0x0
    ...
    invoke-virtual {v12, v0, v14}, Lcom/android/internal/policy/PhoneWindow;->setTitle(Ljava/lang/CharSequence;Z)V
    :try_end_5
    ...
    .end local v12    # "win":Lcom/android/internal/policy/PhoneWindow;
    ...
    const-string/jumbo v16, " already running, starting window not displayed. "
    ...
    .restart local v12    # "win":Lcom/android/internal/policy/PhoneWindow;
    ...
    const-string/jumbo v16, " failed creating starting window"
    ...
    .restart local v9    # "themeController":Landroid/content/res/ThemeController;
    .restart local v11    # "view":Landroid/view/View;
    .restart local v12    # "win":Lcom/android/internal/policy/PhoneWindow;
    .local v13, "wm":Landroid/view/WindowManager;
    :cond_f
    ...
    :try_start_9
    invoke-virtual {v12, v14, v15}, Lcom/android/internal/policy/PhoneWindow;->setStartupWindowTheme(ZI)V
    :try_end_9
...
.method public dump(Ljava/lang/String;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 8455
    sput-boolean v0, Lcom/android/server/policy/PhoneWindowManager;->SHOW_STARTING_ANIMATIONS:Z
    ...
    const-string/jumbo v1, "mShowingLockscreen="

    invoke-virtual {p2, v1}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-boolean v1, p0, Lcom/android/server/policy/PhoneWindowManager;->mShowingLockscreen:Z
    ...
    const-string/jumbo v1, "mWinDismissingKeyguard="
    ...
    .line 8618
    const-string/jumbo v1, " mHideLockScreen="
    ...
    const-string/jumbo v1, "mDismissKeyguard="

    invoke-virtual {p2, v1}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget v1, p0, Lcom/android/server/policy/PhoneWindowManager;->mDismissKeyguard:I

    invoke-virtual {p2, v1}, Ljava/io/PrintWriter;->print(I)V

    .line 8623
    const-string/jumbo v1, " mCurrentlyDismissingKeyguard="

    invoke-virtual {p2, v1}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-boolean v1, p0, Lcom/android/server/policy/PhoneWindowManager;->mCurrentlyDismissingKeyguard:Z
...
.method public finishPostLayoutPolicyLw()I
    ...
    invoke-virtual {v10}, Lcom/android/server/policy/OpGlobalActions$ActionState;->ordinal()I

    move-result v10

    .line 5621
    sget-object v11, Lcom/android/server/policy/OpGlobalActions$ActionState;->INIT:Lcom/android/server/policy/OpGlobalActions$ActionState;

    invoke-virtual {v11}, Lcom/android/server/policy/OpGlobalActions$ActionState;->ordinal()I
    ...
    invoke-virtual {p0, v10}, Lcom/android/server/policy/PhoneWindowManager;->setKeyguardOccludedLw(Z)Z
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mWindowManagerInternal:Landroid/view/WindowManagerInternal;
    ...
    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mActivityManagerInternal:Landroid/app/ActivityManagerInternal;
    ...
    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mInputManagerInternal:Landroid/hardware/input/InputManagerInternal;
    ...
    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mPowerManagerInternal:Landroid/os/PowerManagerInternal;
    ...
    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mAppOpsManager:Landroid/app/AppOpsManager;
    ...
    iput-boolean v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mHasFeatureWatch:Z

    invoke-virtual/range {p1 .. p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v4

    const v5, #android:bool@config_enableBurnInProtection#t
    ...
    const-string v4, "persist.debug.force_burn_in"
    ...
    .line 1749
    .local v11, "burnInProtectionDevMode":Z
    if-nez v12, :cond_0
    ...
    :goto_0
    new-instance v4, Lcom/android/server/policy/BurnInProtectionHelper;
    ...
    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mBurnInProtectionHelper:Lcom/android/server/policy/BurnInProtectionHelper;
    ...
    :cond_1
    new-instance v4, Lcom/android/server/policy/PhoneWindowManager$PolicyHandler;

    const/4 v5, 0x0

    move-object/from16 v0, p0

    invoke-direct {v4, v0, v5}, Lcom/android/server/policy/PhoneWindowManager$PolicyHandler;-><init>(Lcom/android/server/policy/PhoneWindowManager;Lcom/android/server/policy/PhoneWindowManager$PolicyHandler;)V

    move-object/from16 v0, p0

    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mHandler:Landroid/os/Handler;
    ...
    invoke-direct {v4, v0, v5, v1}, Lcom/android/server/policy/PhoneWindowManager$MyWakeGestureListener;-><init>(Lcom/android/server/policy/PhoneWindowManager;Landroid/content/Context;Landroid/os/Handler;)V
    ...
    .line 1780
    new-instance v4, Lcom/android/server/policy/PhoneWindowManager$MyOrientationListener;
    ...
    invoke-direct {v4, v0, v5, v1}, Lcom/android/server/policy/PhoneWindowManager$MyOrientationListener;-><init>(Lcom/android/server/policy/PhoneWindowManager;Landroid/content/Context;Landroid/os/Handler;)V

    move-object/from16 v0, p0

    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mOrientationListener:Lcom/android/server/policy/PhoneWindowManager$MyOrientationListener;
    ...
    invoke-virtual {v4, v5}, Lcom/android/server/policy/PhoneWindowManager$MyOrientationListener;->setCurrentRotation(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

    .line 1784
    :goto_1
    new-instance v4, Lcom/android/server/policy/PhoneWindowManager$SettingsObserver;
    ...
    invoke-direct {v4, v0, v5}, Lcom/android/server/policy/PhoneWindowManager$SettingsObserver;-><init>(Lcom/android/server/policy/PhoneWindowManager;Landroid/os/Handler;)V

    move-object/from16 v0, p0

    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mSettingsObserver:Lcom/android/server/policy/PhoneWindowManager$SettingsObserver;

    .line 1785
    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mSettingsObserver:Lcom/android/server/policy/PhoneWindowManager$SettingsObserver;

    invoke-virtual {v4}, Lcom/android/server/policy/PhoneWindowManager$SettingsObserver;->observe()V

    .line 1786
    new-instance v4, Lcom/android/server/policy/ShortcutManager;

    move-object/from16 v0, p1

    invoke-direct {v4, v0}, Lcom/android/server/policy/ShortcutManager;-><init>(Landroid/content/Context;)V

    move-object/from16 v0, p0

    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mShortcutManager:Lcom/android/server/policy/ShortcutManager;
    ...
    const v5, #android:bool@config_enableCarDockHomeLaunch#t
    ...
    const-string/jumbo v5, "android.intent.category.CAR_DOCK"
    ...
    const-string/jumbo v5, "android.intent.category.DESK_DOCK"
    ...
    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mPowerManager:Landroid/os/PowerManager;
    ...
    .line 1806
    const-string/jumbo v5, "PhoneWindowManager.mBroadcastWakeLock"
    ...
    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mBroadcastWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    .line 1808
    const-string/jumbo v5, "PhoneWindowManager.mPowerKeyWakeLock"
    ...
    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mPowerKeyWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-boolean v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mEnableShiftMenuBugReports:Z
    ...
    const v5, #android:bool@config_supportAutoRotation#t
    ...
    iput-boolean v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mSupportAutoRotation:Z

    const v4, #android:integer@config_lidOpenRotation#t

    move-object/from16 v0, p0

    invoke-direct {v0, v4}, Lcom/android/server/policy/PhoneWindowManager;->readRotation(I)I

    move-result v4

    move-object/from16 v0, p0

    iput v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mLidOpenRotation:I
    ...
    iput v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mCarDockRotation:I
    ...
    iput v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mDeskDockRotation:I
    ...
    iput v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mUndockedHdmiRotation:I
    ...
    iput-boolean v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mCarDockEnablesAccelerometer:Z
    ...
    iput-boolean v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mDeskDockEnablesAccelerometer:Z
    ...
    iput v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mLidKeyboardAccessibility:I
    ...
    iput v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mLidNavigationAccessibility:I
    ...
    const v5, #android:bool@config_lidControlsScreenLock#t
    ...
    iput-boolean v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mLidControlsScreenLock:Z
    ...
    iput-boolean v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mLidControlsSleep:Z
    ...
    iput-boolean v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mTranslucentDecorEnabled:Z
    ...
    const v5, #android:bool@config_allowTheaterModeWakeFromKey#t
    ...
    iput-boolean v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mAllowTheaterModeWakeFromKey:Z

    .line 1837
    move-object/from16 v0, p0

    iget-boolean v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mAllowTheaterModeWakeFromKey:Z
    ...
    const v5, #android:bool@config_allowTheaterModeWakeFromPowerKey#t
    ...
    iput-boolean v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mAllowTheaterModeWakeFromPowerKey:Z
    ...
    const v5, #android:bool@config_allowTheaterModeWakeFromMotion#t
    ...
    iput-boolean v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mAllowTheaterModeWakeFromMotion:Z
    ...
    const v5, #android:bool@config_allowTheaterModeWakeFromMotionWhenNotDreaming#t
    ...
    iput-boolean v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mAllowTheaterModeWakeFromMotionWhenNotDreaming:Z
    ...
    const v5, #android:bool@config_allowTheaterModeWakeFromCameraLens#t
    ...
    iput-boolean v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mAllowTheaterModeWakeFromCameraLens:Z
    ...
    const v5, #android:bool@config_allowTheaterModeWakeFromLidSwitch#t
    ...
    iput-boolean v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mAllowTheaterModeWakeFromLidSwitch:Z
    ...
    const v5, #android:bool@config_allowTheaterModeWakeFromGesture#t
    ...
    iput-boolean v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mAllowTheaterModeWakeFromWakeGesture:Z
    ...
    const v5, #android:bool@config_goToSleepOnButtonPressTheaterMode#t
    ...
    iput-boolean v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mGoToSleepOnButtonPressTheaterMode:Z
    ...
    const v5, #android:bool@config_supportLongPressPowerWhenNonInteractive#t
    ...
    iput-boolean v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mSupportLongPressPowerWhenNonInteractive:Z
    ...
    const v5, #android:integer@config_longPressOnBackBehavior#t
    ...
    iput v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mLongPressOnBackBehavior:I
    ...
    const v5, #android:integer@config_shortPressOnPowerBehavior#t
    ...
    iput v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mShortPressOnPowerBehavior:I
    ...
    iput v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mLongPressOnPowerBehavior:I
    ...
    const v5, #android:integer@config_doublePressOnPowerBehavior#t
    ...
    iput v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mDoublePressOnPowerBehavior:I
    ...
    const v5, #android:integer@config_triplePressOnPowerBehavior#t
    ...
    iput v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mTriplePressOnPowerBehavior:I
    ...
    const v5, #android:integer@config_shortPressOnSleepBehavior#t
    ...
    iput v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mShortPressOnSleepBehavior:I
    ...
    invoke-static {v4}, Landroid/media/AudioSystem;->getPlatformType(Landroid/content/Context;)I
    ...
    iput-boolean v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mUseTvRouting:Z
    ...
    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mAccessibilityManager:Landroid/view/accessibility/AccessibilityManager;
    ...
    iget-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mDockReceiver:Landroid/content/BroadcastReceiver;

    move-object/from16 v0, p1

    invoke-virtual {v0, v4, v14}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    ...
    iput v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mDockMode:I
    ...
    const-string/jumbo v4, "android.intent.action.DREAMING_STARTED"

    invoke-virtual {v14, v4}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 1895
    const-string/jumbo v4, "android.intent.action.DREAMING_STOPPED"
    ...
    invoke-direct {v5, v0}, Lcom/android/server/policy/PhoneWindowManager$15;-><init>(Lcom/android/server/policy/PhoneWindowManager;)V

    .line 1903
    move-object/from16 v0, p1

    invoke-direct {v4, v0, v5}, Lcom/android/server/policy/SystemGesturesPointerEventListener;-><init>(Landroid/content/Context;Lcom/android/server/policy/SystemGesturesPointerEventListener$Callbacks;)V

    move-object/from16 v0, p0

    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mSystemGestures:Lcom/android/server/policy/SystemGesturesPointerEventListener;
    ...
    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mImmersiveModeConfirmation:Lcom/android/server/policy/ImmersiveModeConfirmation;
    ...
    const-string/jumbo v4, "org.codeaurora.intent.action.WIFI_DISPLAY_VIDEO"
    ...
    iget-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mWifiDisplayReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mVirtualKeyVibePattern:[J
    ...
    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mKeyboardTapVibePattern:[J
    ...
    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mClockTickVibePattern:[J
    ...
    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mSafeModeDisabledVibePattern:[J
    ...
    const v5, #android:array@config_contextClickVibePattern#t
    ...
    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mContextClickVibePattern:[J
    ...
    invoke-static {v4, v5, v0, v1}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I

    move-result v4

    move-object/from16 v0, p0

    iput v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mVibrateOnTouchIntensity:I

    .line 1996
    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mVirtualKeyVibePattern:[J
    ...
    iput-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mLockPatternVibePattern:[J

    .line 1999
    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mLockPatternVibePattern:[J

    move-object/from16 v0, p0

    iget v5, v0, Lcom/android/server/policy/PhoneWindowManager;->mVibrateOnTouchIntensity:I
    ...
    iget-object v5, v0, Lcom/android/server/policy/PhoneWindowManager;->mLockPatternVibePattern:[J

    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/server/policy/PhoneWindowManager;->mVirtualKeyVibePattern:[J
    ...
    invoke-static {v4, v0, v5, v1, v2}, Ljava/lang/System;->arraycopy([JI[JII)V
    ...
    invoke-virtual {v0, v4}, Lcom/android/server/policy/PhoneWindowManager;->startedGoingToSleep(I)V
    ...
    invoke-virtual {v0, v4}, Lcom/android/server/policy/PhoneWindowManager;->finishedGoingToSleep(I)V
    ...
    invoke-virtual {v5}, Lcom/android/server/policy/StatusBarController;->getAppTransitionListener()Landroid/view/WindowManagerInternal$AppTransitionListener;

    move-result-object v5

    invoke-virtual {v4, v5}, Landroid/view/WindowManagerInternal;->registerAppTransitionListener(Landroid/view/WindowManagerInternal$AppTransitionListener;)V
    ...
    .restart local v6    # "minHorizontal":I
    .restart local v7    # "maxHorizontal":I
    .restart local v8    # "minVertical":I
    .restart local v9    # "maxVertical":I
    :cond_4
    const/4 v10, -0x1

    .restart local v10    # "maxRadius":I
    goto/16 :goto_0
    ...
    const v4, #android:integer@config_burnInProtectionMinHorizontalOffset#t
    ...
    .restart local v6    # "minHorizontal":I
    const v4, #android:integer@config_burnInProtectionMaxHorizontalOffset#t
    ...
    .restart local v7    # "maxHorizontal":I
    const v4, #android:integer@config_burnInProtectionMinVerticalOffset#t
    ...
    .restart local v8    # "minVertical":I
    const v4, #android:integer@config_burnInProtectionMaxVerticalOffset#t
    ...
    .restart local v9    # "maxVertical":I
    const v4, #android:integer@config_burnInProtectionMaxRadius#t
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;I)I
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;->isFingerprintAuthenticating()Z
    ...
    const-string v21, "change interactive to false"

    invoke-static/range {v20 .. v21}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    const/16 v16, 0x0

    .end local v16    # "newInteractive":Z
    :cond_27
    if-eqz v7, :cond_28
    ...
    invoke-direct {v0, v1, v2, v6}, Lcom/android/server/policy/PhoneWindowManager;->interceptPowerKeyUp(Landroid/view/KeyEvent;ZZ)V
...
.method public performHapticFeedbackLw(Landroid/view/WindowManagerPolicy$WindowState;IZ)Z
    ...
    .local v4, "pattern":[J
    :sswitch_1
    iget-object v4, p0, Lcom/android/server/policy/PhoneWindowManager;->mLockPatternVibePattern:[J
...
.method protected preloadRecentApps()V
    ...
    .prologue
    invoke-virtual {p0}, Lcom/android/server/policy/PhoneWindowManager;->isKeyguardShowingOrOccluded()Z
...
.method public setInitialDisplaySize(Landroid/view/Display;III)V
    ...
    const-string v8, "buttons_show_on_screen_navkeys"
...
.method setKeyguardOccludedLw(Z)Z
    ...
    invoke-virtual {v3, v4, v4}, Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;->setOccluded(ZZ)V
...
.method protected startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
    .locals 3
...
.method public systemReady()V
    ...
    iget-object v4, p0, Lcom/android/server/policy/PhoneWindowManager;->mKeyguardFingerprintChanageCallback:Ljava/lang/Runnable;

    invoke-direct {v1, v2, v3, v4}, Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;-><init>(Landroid/content/Context;Lcom/android/server/policy/keyguard/KeyguardStateMonitor$OnShowingStateChangedCallback;Ljava/lang/Runnable;)V
...
.method protected takeScreenshot(I)V
    ...
    const-string v10, "not handle next screenshot before finishing"
    ...
    invoke-direct {v0, p0, p1, v5}, Lcom/android/server/policy/PhoneWindowManager$18;-><init>(Lcom/android/server/policy/PhoneWindowManager;ILandroid/os/Bundle;)V
    ...
    .restart local v1    # "dockMinimized":Z
    .restart local v4    # "longshotComponent":Landroid/content/ComponentName;
    .restart local v6    # "serviceComponent":Landroid/content/ComponentName;
    .restart local v7    # "serviceIntent":Landroid/content/Intent;
    :cond_7
    const/4 v3, 0x1
...
.method public updateSettings()V
    ...
    iput v9, p0, Lcom/android/server/policy/PhoneWindowManager;->mEndcallBehavior:I
    ...
    iput v9, p0, Lcom/android/server/policy/PhoneWindowManager;->mIncallPowerBehavior:I
    ...
    const-string v9, "vibrate_on_touch_intensity"
    ...
    iget-object v9, p0, Lcom/android/server/policy/PhoneWindowManager;->mLockPatternVibePattern:[J
    ...
    iget v9, p0, Lcom/android/server/policy/PhoneWindowManager;->mVibrateOnTouchIntensity:I
    ...
    const-string v12, "update vibrate_on_touch to "
    ...
    :cond_1
    iput v2, p0, Lcom/android/server/policy/PhoneWindowManager;->mVibrateOnTouchIntensity:I
    ...
    iget v9, p0, Lcom/android/server/policy/PhoneWindowManager;->mUserRotation:I
    ...
    :goto_2
    iget v9, p0, Lcom/android/server/policy/PhoneWindowManager;->mUserRotationMode:I
    ...
    :cond_4
    iget-boolean v9, p0, Lcom/android/server/policy/PhoneWindowManager;->mSystemReady:Z
    ...
    iget v9, p0, Lcom/android/server/policy/PhoneWindowManager;->mPointerLocationMode:I
